...
{{-- <aside id="logo-sidebar" class="border-r fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-slate-50">
      <ul class="space-y-2">
         <li>
            <a href="#" class="border flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-purple-900 hover:text-white group">
         ...
         <li>
            <button type="button" class="border flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-purple-900 hover:text-white group" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap font-medium" sidebar-toggle-item>E-commerce</span>
                  <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </button>
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  <li>
                     <a href="#" class="border flex items-center w-full p-2 text-base font-normal text-black transition duration-75 rounded-lg pl-11 hover:bg-purple-900 hover:text-white group">Products</a>
                  </li>
                  <li>
                     <a href="#" class="border flex items-center w-full p-2 text-base font-normal text-black transition duration-75 rounded-lg pl-11 hover:bg-purple-900 hover:text-white group">Billing</a>
                  </li>
                  <li>
                     <a href="#" class="border flex items-center w-full p-2 text-base font-normal text-black transition duration-75 rounded-lg pl-11 hover:bg-purple-900 hover:text-white group">Invoice</a>
                  </li>
            </ul>
         </li>
         <li>
         ...
         <li>
            <a href="#" class="border flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-purple-900 hover:text-white group">
               ...
               <span class="flex-1 ml-3 whitespace-nowrap font-medium">Sign Up</span>
            </a>
         </li>
      </ul>
   </div>
