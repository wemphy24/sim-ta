                ...
                <table class="w-full text-sm text-left text-gray-600">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="py-4 px-6">
                                {{ $material->updated_at->format('m/d/Y') }}
                            </td>
                            <td class="py-4 px-6">
                                <div class="flex items-center gap-4">
                                    <button wire:click="showMaterialEditModal( {{ $material->id }} )">
            ...
            >
                <div class="bg-white p-4 rounded-xl shadow-md">
                    <div class="flex justify-between items-center">
                        @if($isEditMode === true)
                            <h1 class="font-medium text-xl">Update Material</h1>
                        @else
                            <h1 class="font-medium text-xl">Add Material</h1>
                        @endif
