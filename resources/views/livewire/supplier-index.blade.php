        ...
        <div class="m-6">
            <div class="flex justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <a href="#">
                        <div class="font-medium text-lg">Supplier</div>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="overflow-x-auto shadow-sm sm:rounded-xl border border-gray-300/50">
                <div class="bg-white border-b-2 py-3 px-6 flex justify-between gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <button wire:click="showSupplierModal" class="py-2 px-4 text-center text-white rounded-lg border bg-purple-900">
                            <div class="flex items-center gap-1">
                    ...
                    <tbody>
                        ...
                        @foreach ($suppliers as $supplier)
                            <tr class="bg-white border-b hover:bg-gray-100 hover:text-black font-medium">
                                <td class="py-4 px-6">{{ ($suppliers ->currentpage()-1) * $suppliers ->perpage() + $loop->index + 1 }}</td>
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex items-center gap-4">
                                        <button title="Edit" wire:click="showSupplierEditModal( {{ $supplier->id }} )">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                        </button>
                                        <button title="Hapus" wire:click="deleteSupplier({{ $supplier->id }})">
