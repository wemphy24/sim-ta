<div class="main-content bg-gray-50 flex-1 md:ml-64 h-screen">
    ...
    @section('title', 'RABP')
        ...
        @if ($showingMainPage)
            ...
            <!-- Main modal -->
            @if ($showingApproval)
            <div tabindex="-1" aria-hidden="true" class="z-50 bg-black bg-opacity-50 fixed inset-0 flex justify-center items-center">
                <div class="relative w-full h-full max-w-md md:h-auto">
                    <!-- Modal content -->
                    <div class="relative bg-white rounded-lg shadow">
                        <button wire:click="closeModal" type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
