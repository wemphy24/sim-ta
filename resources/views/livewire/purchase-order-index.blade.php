                    ...
                    <tbody>
                        @foreach ($purchaseorders as $po)
                            <tr class="bg-white border-b hover:bg-gray-50 hover:text-black text-sm">
                                <td class="py-2 px-4">{{ ($purchaseorders ->currentpage()-1) * $purchaseorders ->perpage() + $loop->index + 1 }}</td>
                                <td class="py-2 px-2 font-bold">{{ $po->purchase_order_code }}</td>
                                <td class="py-2 px-2">{{ $po->name }}</td>
                                <td class="py-2 px-2">{{ $po->description }}</td>
                                <td class="py-2 px-2">{{ $po->supplier['name'] }}</td>
                                <td class="py-2 px-2">{{ date('d-m-Y', strtotime($po->po_date)) }}</td>
                                <td class="py-2 px-2">
                                ...
                                <td class="py-2 px-2">
                                    <div class="flex items-center gap-4">
                                        ...
                                        @if ($po->status['name'] == "Pending")
                                            <button wire:click="approvee({{ $po->id }})" class="text-white bg-green-500 p-2 rounded-lg font-medium hover:scale-105 hover:-translate-x-0 hover:duration-150">
                                                Approve
                                            </button>
                                        @else
